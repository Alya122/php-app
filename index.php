...
<head>
    ...
    <title>Мобилни телефони втора употреба</title>
...
<body>
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: rgb(21, 78, 139);">
            <div class="container-fluid">
                <a class="navbar-brand fw-bold" href="#">Мобилни телефони</a>
    ...
    <footer style="background-color: rgb(21, 78, 139);" class="text-center py-5 mt-auto">
        <div class="container">
