...
if (isset($_POST['submit'])) {
    ...
    if (count($errors) > 0) {
        ...
        echo '<div class="alert alert-success" role="alert">Благодарим Ви за съобщението, ' . htmlspecialchars($_POST['name']) . '! На имейл адрес ' . htmlspecialchars($_POST['email']) . ' ще получите отговор.</div>';
    }
}
